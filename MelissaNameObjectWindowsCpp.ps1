<#
.SYNOPSIS
    Downloads the required components and then builds and runs MelissaNameObjectWindowsCpp
...
.DESCRIPTION
    ...
    inside the MSVC build environment and runs it against the supplied name.
    ...
    Overall flow:
      ...
      4. Build with nmake (via BuildProgram.ps1) and run (single test name or interactive).
...
.EXAMPLE
    .\MelissaNameObjectWindowsCpp.ps1 -license "your-license"

.EXAMPLE
    .\MelissaNameObjectWindowsCpp.ps1 -name "Ray Melissa" -license "your-license"
#>
